...
// OpenAI API call
async function callOpenAI(apiKey, model, messages, maxTokens, temperature, stream) {
...
// Anthropic API call
async function callAnthropic(apiKey, model, messages, maxTokens, temperature, stream) {
...
async function callGoogle(apiKey, model, messages, maxTokens, temperature, stream) {
